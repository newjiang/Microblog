...
public class HomeFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        if (microblogList.isEmpty()) {
            ...
            Toast.makeText(context, "请求请求", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(context, "不不不", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
    ...
    public void onError(String result) {
        ...
        Toast.makeText(context, "错误" + result, Toast.LENGTH_SHORT).show();
    }
    /**
